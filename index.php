...
<?php if (checkAuthentication()): ?>
    ...
    <p>
        <a href="create-article.php">Create shipment</a>
    </p>
    ...
    <?php foreach ($shipments as $shipment) { ?>
        <li>
            <shipment>
                ...
                <p>Date Received: <?= $shipment['date_received'] ? htmlspecialchars(date("Y-m-d H:i:s", strtotime($shipment['date_received'])), ENT_QUOTES, 'UTF-8') : 'N/A'; ?></p>
